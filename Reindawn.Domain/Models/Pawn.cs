...
namespace Reindawn.Domain.Models
{
    public class Pawn
    {
        ...
        public virtual ICollection<SignatureCard> SignatureCards { get; set; }
        //public Guid PawnTicketId { get; set; }
        //public virtual PawnTicket PawnTicket { get; set; }
        public virtual ICollection<PawnTicket> PawnTickets { get; set; }
        public DateTime DatePosted { get; set; }

        public virtual ICollection<InterestPay> InterestPays { get; set; }
    }
}
