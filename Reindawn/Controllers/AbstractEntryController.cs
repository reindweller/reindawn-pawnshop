...
namespace Reindawn.Controllers
{
        ...
        where TViewModel : class, new()
    {
        ...
        public virtual ActionResult Create(Guid? id = null)
        {
            ...
            var viewModel = new TViewModel();
            viewModel = SetViewModelFromParent(id, viewModel);
            object model = SetViewModelData(viewModel);
            if (model != null)
            {
                return PartialView(model);
        ...
        //protected abstract void SetViewBagForIndexView(Guid? id);

        protected abstract TViewModel SetViewModelFromParent(Guid? id, TViewModel viewModel);

        //protected abstract void SetViewBagsForEdit(Guid? id);
